...
{
       0,    29,    29,    36,    39,    43,    49,    53,    62,    68,
      72,    75,    81,    87,    97,   101,   102,   106,   115,   123,
     124,   128,   132,   136,   139,   143,   147,   151,   155,   159,
     163,   170,   174,   178,   182,   186,   190,   194,   195,   199,
     200,   203,   207,   214,   215,   219,   225,   229,   230,   231,
     232,   233,   234,   235,   239,   246,   250,   258,   265,   274,
     281,   287,   293,   299
};
#endif
...
{
       3,   -13,    23,    -2,   -60,   -60,    84,    17,     6,     6,
     -60,   -60,   -60,     6,    18,   -60,     1,     5,     7,   -60,
      59,   -60,    65,    19,     6,     6,     6,    93,     6,    41,
      51,    58,     6,    60,    49,   -60,   -60,   -60,   -60,   -60,
     -60,   -60,   -60,    -1,   -60,    38,    52,    71,   -60,   -60,
     -60,   -60,   -60,   -11,   -11,     6,    80,    11,    11,   -60,
      65,     6,    17,   101,   -60,    11,    11,    11,    81,    24,
     -60,    78,    79,   -60,   -60,    32,    99,    11,   -20,    83,
     -60,    18,    86,   -60,   -60,    36,    11,    11,    11,   111,
      11,    11,    11,    11,    11,    11,    11,    11,    11,    11,
      65,    11,    83,    88,    89,   -60,   -60,    93,   -60,    90,
     -60,   -60,    65,    83,    83,    83,    83,    83,    83,    79,
      79,   -60,   -60,   -60,    34,   -60,    11,    91,   -60,   117,
      11,    83,   -60,    65,    53,   -60,    65,   -60
};
...
{
     -60,   -60,    62,   120,   -23,   -60,    27,    -8,   -60,   -60,
     -60,   -60,   110,    82,   -57,   -31,    21,   -59,   -60,    54,
     -60,   -58,   -60,   -60,   -60,   -60,   -60,   -60,   -10,   -60
};
...
{
      16,    17,    80,    48,    23,    21,     1,    84,    83,     3,
      64,    15,    96,    97,    34,    65,    21,    21,    21,    59,
      52,   105,    66,     4,    56,    13,    78,    79,    15,    67,
     110,   111,    64,    15,     5,    60,    85,    22,    48,   121,
     122,    24,   123,    26,    66,    25,   102,    76,    87,    88,
     130,    67,    34,    21,   129,   102,    87,    88,    44,   113,
     114,   115,   116,   117,   118,    89,    96,    97,    96,    97,
     124,   106,    58,   100,    61,   135,    29,   108,   137,    30,
      31,    53,    32,    33,    22,    96,    97,    15,     7,     8,
       9,    54,    34,    62,   136,   131,    27,    28,    55,   134,
      57,    90,    49,    50,    34,    91,    92,    93,    94,    95,
      96,    97,    63,    98,    99,    96,    97,   119,   120,    82,
      77,    86,   101,   112,    81,    34,   107,   126,    34,   125,
     133,   128,   132,    18,   127,    47,    75,     0,     0,     0,
     109
};

static const yytype_int16 yycheck[] =
{
       8,     9,    60,    26,    14,    13,     3,    66,    65,    22,
      21,    22,    32,    33,    22,    26,    24,    25,    26,    20,
      28,    41,    33,     0,    32,     8,    57,    58,    22,    40,
      87,    88,    21,    22,    36,    36,    67,    19,    61,    98,
      99,    40,   100,    36,    33,    40,    77,    55,    24,    25,
      16,    40,    60,    61,   112,    86,    24,    25,    39,    90,
      91,    92,    93,    94,    95,    41,    32,    33,    32,    33,
     101,    81,    23,    41,    36,   133,    11,    41,   136,    14,
      15,    40,    17,    18,    19,    32,    33,    22,     4,     5,
       6,    40,   100,    41,    41,   126,    37,    38,    40,   130,
      40,    23,     9,    10,   112,    27,    28,    29,    30,    31,
      32,    33,    41,    34,    35,    32,    33,    96,    97,    18,
      40,    40,    23,    12,    62,   133,    40,    38,   136,    41,
      13,    41,    41,    13,   107,    25,    54,    -1,    -1,    -1,
      86
};
...
#line 1238 "toypl.tab.c"
    break;

  case 4: /* VarDecl: %empty  */
#line 39 "toypl.y"
                {	(yyval.nodeP)=NULL;	}
#line 1244 "toypl.tab.c"
    break;
...
#line 1255 "toypl.tab.c"
    break;

  case 6: /* DclList: Decl  */
#line 49 "toypl.y"
                {	(yyval.nodeP)=(yyvsp[0].nodeP);	}
#line 1261 "toypl.tab.c"
    break;
...
#line 1283 "toypl.tab.c"
    break;

  case 9: /* VarList: Var  */
#line 68 "toypl.y"
              { (yyval.nodeP)=(yyvsp[0].nodeP); }
#line 1289 "toypl.tab.c"
    break;
...
#line 1328 "toypl.tab.c"
    break;

  case 14: /* SubPgmList: %empty  */
#line 97 "toypl.y"
                {	(yyval.nodeP)=NULL;	}
#line 1334 "toypl.tab.c"
    break;

  case 15: /* SubPgm: ProcDecl  */
#line 101 "toypl.y"
                        {	(yyval.nodeP)=(yyvsp[0].nodeP);	}
#line 1340 "toypl.tab.c"
    break;

  case 16: /* SubPgm: FunDecl  */
#line 102 "toypl.y"
                        {	(yyval.nodeP)=(yyvsp[0].nodeP);	}
#line 1346 "toypl.tab.c"
    break;
...
#line 1357 "toypl.tab.c"
    break;

  case 18: /* FunDecl: TFUNC Var TLPAREN FormParam TRPAREN TRETURN TLPAREN Type TRPAREN  */
#line 115 "toypl.y"
                                                                         {
		(yyval.nodeP) = makeNode("FUNC", NULL, (yyvsp[-7].nodeP));
		(yyvsp[-7].nodeP)->bro = (yyvsp[-5].nodeP);
		(yyvsp[-5].nodeP)->bro = (yyvsp[-1].nodeP);
	}
#line 1367 "toypl.tab.c"
    break;

  case 19: /* FormParam: DclList  */
#line 123 "toypl.y"
                { (yyval.nodeP)=(yyvsp[0].nodeP); }
#line 1373 "toypl.tab.c"
    break;

  case 20: /* FormParam: %empty  */
#line 124 "toypl.y"
          { (yyval.nodeP)=NULL; }
#line 1379 "toypl.tab.c"
    break;
...
#line 1405 "toypl.tab.c"
    break;

  case 24: /* Cond: Rel  */
#line 139 "toypl.y"
              { (yyval.nodeP) = (yyvsp[0].nodeP); }
#line 1411 "toypl.tab.c"
    break;
...
#line 190 "toypl.y"
                {	(yyval.nodeP) = (yyvsp[0].nodeP);	}
#line 1513 "toypl.tab.c"
    break;

  case 37: /* Fact: Var  */
#line 194 "toypl.y"
            {	(yyval.nodeP)=(yyvsp[0].nodeP);	}
#line 1519 "toypl.tab.c"
    break;
...
#line 1542 "toypl.tab.c"
    break;

  case 41: /* Fact: TLPAREN Expr TRPAREN  */
#line 203 "toypl.y"
                               {	(yyval.nodeP)=(yyvsp[-1].nodeP);	}
#line 1548 "toypl.tab.c"
    break;
...
#line 214 "toypl.y"
                        { (yyval.nodeP)=(yyvsp[0].nodeP); }
#line 1563 "toypl.tab.c"
    break;

  case 44: /* ParamList: %empty  */
#line 215 "toypl.y"
          { (yyval.nodeP)=NULL; }
#line 1569 "toypl.tab.c"
    break;
...
#line 1580 "toypl.tab.c"
    break;

  case 46: /* ExprList: Expr  */
#line 225 "toypl.y"
                { (yyval.nodeP)=(yyvsp[0].nodeP); }
#line 1586 "toypl.tab.c"
    break;

  case 47: /* Stmt: AsgnStmt  */
#line 229 "toypl.y"
                        {	(yyval.nodeP)=(yyvsp[0].nodeP);	}
#line 1592 "toypl.tab.c"
    break;

  case 48: /* Stmt: IfStmt  */
#line 230 "toypl.y"
                        {	(yyval.nodeP)=(yyvsp[0].nodeP);	}
#line 1598 "toypl.tab.c"
    break;

  case 49: /* Stmt: WhileStmt  */
#line 231 "toypl.y"
                        {	(yyval.nodeP)=(yyvsp[0].nodeP);	}
#line 1604 "toypl.tab.c"
    break;

  case 50: /* Stmt: ForStmt  */
#line 232 "toypl.y"
                        {	(yyval.nodeP)=(yyvsp[0].nodeP);	}
#line 1610 "toypl.tab.c"
    break;

  case 51: /* Stmt: CallStmt  */
#line 233 "toypl.y"
                        {	(yyval.nodeP)=(yyvsp[0].nodeP);	}
#line 1616 "toypl.tab.c"
    break;

  case 52: /* Stmt: RtrnStmt  */
#line 234 "toypl.y"
                        {	(yyval.nodeP)=(yyvsp[0].nodeP);	}
#line 1622 "toypl.tab.c"
    break;

  case 53: /* Stmt: CompStmt  */
#line 235 "toypl.y"
                        {	(yyval.nodeP)=(yyvsp[0].nodeP);	}
#line 1628 "toypl.tab.c"
    break;
...
#line 1712 "toypl.tab.c"
    break;

  case 63: /* StmtList: Stmt  */
#line 299 "toypl.y"
               { (yyval.nodeP) = (yyvsp[0].nodeP); }
#line 1718 "toypl.tab.c"
    break;


#line 1722 "toypl.tab.c"
